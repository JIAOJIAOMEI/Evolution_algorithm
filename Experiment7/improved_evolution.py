...
def test(function, mode, parameter_list, opt, mutation_type, crossover_type, local_search_type, local_pattern_type):
    iterations = 100
    ...
    num_phenotypes = int(parameter_list[5])

    func, num_genes, genotype_range = choose_func(function)
    individuals = initialization(func=func, num_phenotypes=num_phenotypes, num_genes=num_genes,
    ...
    new = Individual(func=func, num_phenotypes=num_phenotypes, num_genes=num_genes, genotype=new_individual,
                     genotype_range=genotype_range, local_search=local_search, local_search_range=local_search_range,
                     pattern=1, local_search_type=local_search_type, local_pattern_type=local_pattern_type)
        ...
        for f in range(1, 24, 1):
            ...
            for times in range(Times):
                result = test(function=f, mode=mode, parameter_list=combination, opt=global_opt[f - 1],
                              mutation_type=type_list[0], crossover_type=type_list[1], local_search_type=type_list[2],
                              local_pattern_type=type_list[3])
