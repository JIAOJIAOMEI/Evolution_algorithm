...
class Individual:
    def __init__(self, func, num_genes, genotype_range, mutation_rate, crossover_rate, mutation_type, crossover_type,
        ...
        if algorithm == "Baseline":
            ...
            self.phenotype, self.fitness = local_search(self.genotype, self.genotype_range, self.num_genes,
                                                        local_search_type,
                                                        local_search_rate, self.search_radius, length_of_local_search,
                                                        self.func, self.fitness_genotype)
            self.fitness = self.fitness - self.fitness_genotype
