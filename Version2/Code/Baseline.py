...
class Individual0:
    def __init__(self, num_genes, genotype_range):
...
def initialization(num_genes, num_individual, genotype_range):
    ...
    for _ in range(0, num_individual):
        individuals.append(
            Individual0(num_genes=num_genes,genotype_range=genotype_range))
    return individuals
...
def test(function, parameter_list):
    ...
    new = Individual(genotype=new_individual)
    ...
    for i in range(L[0], L[1], 1):
        ...
        for f in range(1, 24, 1):
            ...
            for times in range(Times):
                result = test(function=f, parameter_list=combination[i])
