...
if __name__ == '__main__':
    ...
    com_df["R"] = 0.1
    # 5、20、21、22、23这个函数不好调，但是8、9、14：1，0.3是可以的；1、2、3、4、6、7、10、11、12、13、15、16、17、18：1，0.01
    ...
    for i in range(0, len(com), 1):
        ...
        data, data_budget, data_similarity = improved_evolution.multipleF(Times=30, L=[0, 1], Com=com[i],
                                                                          mode="Lamarck",
