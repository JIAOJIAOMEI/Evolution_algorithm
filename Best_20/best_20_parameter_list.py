...
lst1 = [[146, 164, 163, 145, 162, 144, 199, 182, 180, 181, 198, 23, 5, 22, 77, 41, 59, 95, 4, 21],
        [56, 91, 92, 199, 163, 126, 36, 108, 198, 59, 95, 23, 22, 131, 57, 94, 98, 130, 113, 80],
...
lst2 = [[110, 128, 146, 164, 145, 163, 182, 144, 162, 199, 181, 198, 180, 23, 59, 22, 5, 95, 41, 58],
        [128, 110, 164, 146, 163, 145, 182, 144, 162, 199, 181, 198, 180, 23, 59, 41, 21, 5, 95, 58],
...
df.to_csv('./best_combination.csv',
          sep=',',
          header=True,
          index=True)
# display(df)

df = pd.read_csv("./best_combination.csv",
                 index_col=[0],
                 header=0)
# display(df)
